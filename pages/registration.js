		...
		return (
			<ImageBackground source={require('../images/SignUpBkGrnd.png')} style={{width: '100%', height: '100%',  resizeMode: 'stretch'}}>
                ...
                <View style={{alignItems:'center'}}>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('Home')} style={[styles.roundButton,{justifyContent:'flex-start', paddingLeft:width*.05, backgroundColor:'#343434',}]}>
                ...
                <View style={{alignItems:'center'}}>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('CreateAccount')} style={[styles.roundButton,{justifyContent:'flex-start', paddingLeft:width*.05, borderWidth:2, borderColor:'#FDC500', }]}>
