                ...
                <View style={{ flex: 1, backgroundColor: '#f5c711' }}>
                    ...
                    {this.state.editStatus == 0 ?
                        <View>
                            ...
                            <View style={{ alignItems: 'center' }}>
                                <View style={styles.profileTextInput}>
                                    <Text style={styles.textinputText}>{this.state.dataSource.billing.phone}</Text>
                                </View>
                            </View>
                            <View style={{ alignItems: 'center' }}>
                                <View style={styles.profileTextInput}>
                        ...
                        <View style={{ marginBottom: height * .15, marginTop: height * .05 }}>
                            <ScrollView>
                                <View style={{ alignItems: 'center' }}>
                                    <View style={styles.profileTextInput}>
                                        <TextInput style={styles.textinputText}
                                            placeholder={this.state.dataSource.first_name}
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    <TouchableOpacity onPress={() => { this.upadateUser() }} style={{ width: width * .9, marginTop: width * .05, alignItems: 'center', justifyContent: 'center', backgroundColor: '#343434', height: height * 0.08, borderRadius: 3 }}>
