                                ...
                                <FlatList
                                    ...
                                    renderItem={({ item, index }) => (
                                        ...
                                        <TouchableOpacity
                                            ...
                                            style={{ width: width * .5, height: width * .65, backgroundColor: 'rgba(255,255,255,1)', borderRightWidth: .5, marginBottom: 10 }}>
                                            <View style={{ alignItems: 'center' }}>
                                                <Image
                                                    ...
                                                    style={{ width: width * .45, height: width * .5, }}
                                                />
                                            </View>
                                            <View style={{ flexDirection: 'row', padding: 5, justifyContent: 'space-between' }}>
                                                <Text style={[styles.TitleText, { color: '#343434', fontSize: 14, width: width * .28 }]} numberOfLines={1}>{item.title}</Text>
                                            ...
                                            <View style={{ flexDirection: 'column', padding: 5, justifyContent: 'space-between', }}>
                                                <Text style={[styles.TitleText, { color: '#343434', fontSize: 14, width: width * .4 }]}>{item.specialization}</Text>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => (
                                    ...
                                    <TouchableOpacity
                                        // onPress={() => this.props.navigation.navigate('DoctorDetails', { petData: item })}
                                        onPress={() => this._onPress(item)}
                                        style={{ width: width * 1, height: width * .65, backgroundColor: 'rgba(255,255,255,1)', borderRightWidth: .5, marginBottom: 10 }}>
                                        <View style={{ alignItems: 'center' }}>
                                            <Image
                                                // source={{ uri: item.images[0] ? item.images[0].src : "https://www.aiimsnagpur.edu.in/sites/default/files/inline-images/no-image-icon_27.png" }}
                                                source={{ uri: item.image }}
                                        ...
                                        <View style={{ alignItems: 'center', marginTop: 5 }}>
                                            <Text style={[styles.TitleText, { color: '#343434', fontSize: 14, textAlign: 'center' }]}>{item.title}</Text>
                                ...
                                /> */}
                                        ...
                                        <View style={{ flexDirection: 'column', padding: 5, justifyContent: 'space-between', }}>
                                            <Text style={[styles.TitleText, { color: '#343434', fontSize: 14, textAlign: 'center' }]}>{item.specialization}</Text>
                                            {/* <Text style={[styles.TitleText, { color: '#343434', fontSize: 12 }]}>₹{item.price}</Text> */}
